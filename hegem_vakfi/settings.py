"""
Django settings for hegem_vakfi project.
...
WSGI_APPLICATION = 'hegem_vakfi.wsgi.application'
...
PAYMENT_OK_URL = config.PAYMENT_OK_URL
PAYMENT_FAIL_URL = config.PAYMENT_FAIL_URL
PAYMENT_CLIENT_ID = config.PAYMENT_CLIENT_ID
